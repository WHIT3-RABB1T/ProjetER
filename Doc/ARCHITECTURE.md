...
continu. Pour le détail du code, voir `Doc/STM32.md` (carte) et
`Doc/SERVER.md` (serveur).
...
- **Un blocage de plus de 3-4 secondes** (un souci matériel ou réseau plus
  ...
  `Doc/STM32.md` §4 et §8 pour le détail de ce mécanisme et des bugs
...
| Un blocage logiciel profond survient (bug de synchronisation, voir `Doc/STM32.md` §8) | Le chien de garde matériel (IWDG) redémarre la carte après 3-4 secondes d'absence de progrès — retour complet à la phase ①. |
